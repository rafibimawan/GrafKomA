...
void Demo::BuildCube()
{
	...
	int width, height;
	unsigned char* image = SOIL_load_image("mejalesehan_transparent.png", &width, &height, 0, SOIL_LOAD_RGBA);
	...
	float vertices[] = {
		...
		// front
		0.00,0.38,0.00,0,0,0,1,0, // 0
		1.00,0.38,0.00,0,1,0,1,0, // 1
		1.00,0.50,0.00,1,1,0,1,0, // 2
		0.00,0.50,0.00,1,0,0,1,0, // 3

		0.00,0.38,-0.5,0,0,0,1,0, // 4
		1.00,0.38,-0.5,0,1,0,1,0, // 5
		1.00,0.50,-0.5,1,1,0,1,0, // 6
		0.00,0.50,-0.5,1,0,0,1,0, // 7

		0.00,0.38,-0.5,0,0,0,1,0, // 8
		0.00,0.38,0.00,0,1,0,1,0, // 9
		0.00,0.50,0.00,1,1,0,1,0, // 10
		0.00,0.50,-0.5,1,0,0,1,0, // 11

		1.00,0.38,0.00,0,0,0,1,0, // 12
		1.00,0.38,-0.5,0,1,0,1,0, // 13
		1.00,0.50,-0.5,1,1,0,1,0, // 14
		1.00,0.50,0.00,1,0,0,1,0, // 15

		0.00,0.50,-0.5,0,0,0,1,0, // 16
		0.00,0.50,0.00,0,1,0,1,0, // 17
		1.00,0.50,0.00,1,1,0,1,0, // 18
		1.00,0.50,-0.5,1,0,0,1,0, // 19
